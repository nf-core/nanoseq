...
include { PYCOQC              } from '../../modules/local/pycoqc'             addParams( options: params.pycoqc_options )
include { NANOPLOT_SUMMARY    } from '../../modules/local/nanoplot_summary'   addParams( options: params.nanoplot_summary_options )
